...
PREFIX="6TEST_READ_NC_"//TRIM(VNAME)
ODIR="."
...
OUT=TRIM(PREFIX)//"_QA_RUN_"//YYYY//'.nc'
CALL WRITE_NC(TRIM(VNAME), OUT, IM, JM, NM, FLX_QA, timeI, latI, lonI, INDIR, INFLE, ODIR, OFLE)
print '(A,A)','OUTPUT: ',TRIM(OUT)
...
OUT=TRIM(PREFIX)//"_SST_RUN_"//YYYY//'.nc'
CALL WRITE_NC(TRIM(VNAME), OUT, IM, JM, NM, FLX_SST, timeI, latI, lonI, INDIR, INFLE, ODIR, OFLE)
print '(A,A)','OUTPUT: ',TRIM(OUT)

OUT=TRIM(PREFIX)//"_WND_RUN_"//YYYY//'.nc'
CALL WRITE_NC(TRIM(VNAME), OUT, IM, JM, NM, FLX_WND, timeI, latI, lonI, INDIR, INFLE, ODIR, OFLE)
print '(A,A)','OUTPUT: ',TRIM(OUT)
