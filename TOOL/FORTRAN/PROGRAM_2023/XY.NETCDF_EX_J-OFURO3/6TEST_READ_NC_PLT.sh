...
INDIR=.
INFLE1=6TEST_READ_NC_LHF_RAW_RUN_${YYYY}.nc
IN1=$(pwd)/${INDIR}/${INFLE1}
if [ ! -f $IN1 ];then echo NO SUCH FILE,$IN1;exit 1;fi

INFLE2=6TEST_READ_NC_LHF_CLM_RUN_${YYYY}.nc
IN2=$(pwd)/${INDIR}/${INFLE2}
if [ ! -f $IN2 ];then echo NO SUCH FILE,$IN2;exit 1;fi

INFLE3=6TEST_READ_NC_LHF_SST_RUN_${YYYY}.nc
IN3=$(pwd)/${INDIR}/${INFLE3}
if [ ! -f $IN3 ];then echo NO SUCH FILE,$IN3;exit 1;fi

INFLE4=6TEST_READ_NC_LHF_WND_RUN_${YYYY}.nc
IN4=$(pwd)/${INDIR}/${INFLE4}
if [ ! -f $IN4 ];then echo NO SUCH FILE,$IN4;exit 1;fi

INFLE5=6TEST_READ_NC_LHF_QA_RUN_${YYYY}.nc
IN5=$(pwd)/${INDIR}/${INFLE5}
if [ ! -f $IN5 ];then echo NO SUCH FILE,$IN5;exit 1;fi
...
'sdfopen ${IN1}';'sdfopen ${IN2}';'sdfopen ${IN3}';
'sdfopen ${IN4}';'sdfopen ${IN5}';
