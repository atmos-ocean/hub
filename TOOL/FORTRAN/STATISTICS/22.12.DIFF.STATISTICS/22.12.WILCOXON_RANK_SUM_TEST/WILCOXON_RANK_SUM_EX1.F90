...
real(8), dimension(n1) :: sample1 = [28.,30.,40.,31.,32.,33.,38.]

real(8), dimension(n2) :: sample2 = [39.,41.,35.,32.,29.]
...
print '(A,f7.2)',"rank_sum=",rank_sum
print '(A,f7.2)',"dnx     =",dnx
print '(A,f7.2)',"dny     =",dny
print '(A,f7.2)',"U       =",U
print '(A,f7.2)',"avg_U   =",avg_U
print '(A,f7.2)',"var_U   =",var_U
print '(A,f7.2)',"z       =",z
print '(A,f7.2)',"p_value =",p_value
