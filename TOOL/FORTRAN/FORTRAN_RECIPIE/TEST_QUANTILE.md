...
Fri, 12 Jun 2020 21:42:58 +0900
calypso.bosai.go.jp
/work05/manda/WRF.POST/K17/RAIN.10m.QUANTILE/TEST.QUANTILE

```
srcdump.sh TEST_QUANTILE.sh SORTDK.F
```
...
integer,parameter::n=10000,nu=5000
...
allocate(xi(n),x(n),idx(n),mask(n))
...
print '(2f11.1)',sngl(xi(1)),sngl(x(1))
print '(2f11.1)',sngl(xi(2)),sngl(x(2))
print '(A)','...'
print '(2f11.1)',sngl(xi(n-1)),sngl(x(n-1))
print '(2f11.1)',sngl(xi(n)),sngl(x(n))
print *
...
print '(A)','SEARCH INDICES FOR QUANTILES'
n90=nint(n2*0.90+0.5)
n75=nint(n2*0.75+0.5)
n50=nint(n2*0.50+0.5)
n25=nint(n2*0.25+0.5)
n10=nint(n2*0.10+0.5)
print *

print '(A)','QUANTILES:'
print *,'n,nu,n2=',n,nu,n2
print *,'100%', n2,sngl(x(n2))
print *,' 90%',n90,sngl(x(n90))
print *,' 75%',n75,sngl(x(n75))
print *,' 50%',n50,sngl(x(n50))
print *,' 25%',n25,sngl(x(n25))
print *,' 10%',n10,sngl(x(n10))
